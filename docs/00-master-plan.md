...
| 档内容灾实测（standard：qwen-plus→qwen-turbo；deepseek/glm 两版对象均随 #28 作废——M5.0 P6 修正） | M5.4 | 待产出（凭证名 `m5_failover_qwen_tier.txt`；无凭证则修改 05 表述） | ⬜ |
