...
| ⏳ | （M1 七条全表与 M2 八条合并对照，含代码锚） | retro-m0-m1 §5 + retro-m2 定稿后合并 | M5.5 |

---

## 数字凭证卡（M2/M3 毕业版；每个数字有 reports/ 凭证与口径）
...
- **面试前一天**：retro 两篇 §哲学 + interview-questions 全刷（现 74 题）+ 命运表两张
  （compare-langchain-m1 §7 / compare-langgraph-m2 §7）+ 已知边界（防"完美系统"陷阱）；
- ⏳ M3/M4 篇补齐后扩为三条路径（15 分钟/2 小时/半天）。
